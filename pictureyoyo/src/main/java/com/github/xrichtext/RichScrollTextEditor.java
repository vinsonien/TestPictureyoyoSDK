...
public class RichScrollTextEditor extends ScrollView {
    ...
    public RichScrollTextEditor(Context context) {
        this(context, null);
    }

    public RichScrollTextEditor(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RichScrollTextEditor(Context context, AttributeSet attrs, int defStyleAttr) {
